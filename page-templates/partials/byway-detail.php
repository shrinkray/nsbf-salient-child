...
<div class="grid grid-cols-1 mb-12 row md:grid-cols-2 lg:grid-cols-2">
    <div class="order-last section details md:order-none lg:order-none ">
        ...
        <ul class="detail-list mt-7 mb-7">
            <li><span class="label-minor-heading">Designation</span><?php 
            echo esc_html( $designation ); ?> (<?php echo esc_html( $designation_year ) ?>)</li>
            <li><span class="label-minor-heading">Intrinsic Qualities</span><?php 
            echo esc_html( $trimmed); ?></li>
            <li><span class="label-minor-heading">Location</span><?php 
            echo esc_html( $state_or_states_that_contain_byway ); ?></li>
            <li><span class="label-minor-heading">Length</span><?php 
            echo esc_html( $length_of_byway_miles );?>&nbsp;miles</li>
        </ul>
    ...
    if ($dedicated_byway_organization ) :
        ...
        if ($dedicated_byway_organization_website ) :  ?>
                        <a class="byway-website-property" href="<?php 
                        echo esc_url( $dedicated_byway_organization_website );
                        ?>" target="_blank" title="Learn more at the <?php 
                        echo esc_attr( $dedicated_byway_organization ); ?> website!">Website</a>
        <?php endif; ?>
                
        <?php // If we have a phone URL add a link
        if ($dedicated_byway_organization_phone ) :  ?>
                        <a class="byway-phone-property" href="tel:<?php 
                        echo esc_url( $dedicated_byway_organization_phone );
                        ?>" title="Need help? Call our offices."><?php 
                        echo esc_attr( $dedicated_byway_organization_phone );?></a>
        <?php endif; ?>
                ...
                <div class="partner-digits">
                    ...
                    if ($state_dot_name ) : ?>
                        ...
                        if ($state_dot_byway_website ) :  ?>
                                        ...
                                        ?>" target="_blank" title="Learn more at the <?php 
                                        echo esc_attr( $state_dot_name ); ?> website!">Website</a>
                        <?php endif; ?>
                        ...
                        if ($state_dot_byway_phone ) :  ?>
                                        ...
                                        ?>" title="Need help? Call our offices."><?php 
                                        echo esc_attr( $state_dot_byway_phone );?></a>
                        <?php endif; ?>
                ...
                <div class="partner-digits">
                    ...
                    if ($state_tourism_board_name ) :  ?>
                        ...
                        if ($state_tourism_board_website ) :  ?>
                                        ...
                                        ?>" target="_blank" title="Learn more at the <?php 
                                        echo esc_attr( $state_tourism_board_name ); ?> website!">Website</a>
                        <?php endif; ?>
                        ...
                        if ($state_tourism_board_phone ) :  ?>
                                        ...
                                        ?>" title="Need help? Call our offices."><?php 
                                        echo esc_attr( $state_tourism_board_phone );?></a>
                        <?php endif; ?>
                            </div> <!-- .detail-properties -->
