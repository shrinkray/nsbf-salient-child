        ...
        <div class="detail-properties">
			<?php // If we have a website URL add a link
				if ( $state_dot_byway_website ) : ?>
                    <a class="byway-website-property" href="<?php echo esc_url( $state_dot_byway_website );
					?>" target="_blank" title="Learn more at the <?php echo esc_attr( $state_dot_name ); ?> website!">Website</a>
				<?php
			...
			<?php // If we have a phone URL add a link
				if ( $state_dot_byway_phone ) : ?>
                    <a class="byway-phone-property" href="tel:<?php echo esc_url( $state_dot_byway_phone );
					?>" title="Need help? Call our offices."><?php echo esc_attr( $state_dot_byway_phone ); ?></a>
				<?php
        ...
        <div class="detail-properties">
			<?php // If we have a website URL add a link
				if ( $state_tourism_board_website ) :  ?>
                    <a class="byway-website-property" href="<?php echo esc_url( $state_tourism_board_website );
					?>" target="_blank" title="Learn more at the <?php echo esc_attr( $state_tourism_board_name ); ?> website!">Website</a>
				<?php endif; ?>
			
			<?php // If we have a phone URL add a link
				if (  $state_tourism_board_phone ) :  ?>
                    <a class="byway-phone-property" href="tel:<?php echo esc_url( $state_tourism_board_phone );
					?>" title="Need help? Call our offices."><?php echo esc_attr( $state_tourism_board_phone );?></a>
				<?php endif; ?>
		</div> <!-- .detail-properties -->
		<?php endif; ?>
	</div> <!-- .partner-digits -->
