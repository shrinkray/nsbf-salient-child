    ...
    <div class="order-last section details md:order-none lg:order-none ">
        ...
        <ul class="detail-list mt-7 mb-7">
            ...
            <li><span class="label-minor-heading">Designation</span><?php echo esc_html($designation);?> <?php
                    echo $designation_year ? '(' . esc_html($designation_year) . ')' : '' ?></li>
           
            <li><span class="label-minor-heading">Location</span><?php echo esc_html($sb_state);
            ?></li>
        ...
        <div class="detail-subsection">
            ...
            if ($dedicated_byway_organization_website ) :  ?>
                        <a class="byway-website-property" href="<?php echo esc_url($dedicated_byway_organization_website);
            ...
            if ($dedicated_byway_organization_phone ) :  ?>
                        <a class="byway-phone-property" href="tel:<?php echo esc_url($dedicated_byway_organization_phone);
