...
?>
		...
		<?php
		if ( 'page-templates/partials/byway-detail.php' ) :
			require 'page-templates/partials/byway-detail.php';
			endif;
		if ( 'page-templates/partials/byway-overview.php' ) :
			require 'page-templates/partials/byway-overview.php';
			endif;
		if ( 'page-templates/partials/byway-local-partners.php' ) :
			require 'page-templates/partials/byway-local-partners.php';
			endif;
		if ( 'page-templates/partials/byway-story.php' ) :
			require 'page-templates/partials/byway-story.php';
			endif;
